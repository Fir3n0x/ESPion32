...
> **ESPion32** is an ESP32 project which uses an Android application to set up wifi attacks on the provided ESP32 such that sniffing or deauthentication... This application communicates with the ESP32 via BLE. The project aims to perform offensive attacks on wifi, the firmware is written in C. This project is for educational purpose only. Unauthorized scanning or attacking of networks is prohibited. Use this application solely on systems you own or have explicit permission to evaluate.
